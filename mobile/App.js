...
const DrawerHeader = (props) => {
  ...
  return (
    <View style={styles.header}>
      ...
      />
      {/* <Button title='Hello' onPress={() => props.navigation.toggleDrawer()} /> */}
...
export default function App() {
  return (
    <NavigationContainer>
      <Drawer.Navigator
        screenOptions={{drawerPosition: 'right', header: (drawerData) => {return <DrawerHeader navigation={drawerData.navigation}  />}}}
      >
        <Drawer.Screen name='Home' component={HomeView} />
